-- Swap from OpenAI text-embedding-3-small (1536) to Voyage voyage-3 (1024).
-- Safe because no embeddings existed yet — columns are empty.
...
LANGUAGE sql STABLE AS $$
  SELECT
    i.id, i.session_id, i.iteration_number, i.analysis_json, i.director_output_json,
...
LANGUAGE sql STABLE AS $$
  SELECT
    r.id, r.archetype, r.room_type, r.camera_movement, r.provider,
