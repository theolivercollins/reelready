...
See also:
- [../archive/completed-plans/2026-04-19-phase2.8-new-prompt-lab.md](../archive/completed-plans/2026-04-19-phase2.8-new-prompt-lab.md) — implementation plan (SHIPPED)
- [../state/PROJECT-STATE.md](../state/PROJECT-STATE.md) — what actually shipped
- [../specs/2026-04-20-back-on-track-design.md](./2026-04-20-back-on-track-design.md) — the current DM merge absorbs this Lab as the single listings Lab

**Date:** 2026-04-19
**Status:** Design shipped as Phase 2.8 listings Lab; DM (dev/legacy merge) then unified it with the legacy Lab into one surface.
