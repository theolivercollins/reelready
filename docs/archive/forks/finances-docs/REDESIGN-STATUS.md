> **ARCHIVED — FORK SNAPSHOT.** Moved 2026-04-21. Copy from `real-estate-pipeline-finances` (branch `finances-tab`, latest commit 66135be). Stale side-branch; do NOT push to that clone.
>
