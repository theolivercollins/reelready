...
export type LEIconName =
  | "arrow" | "arrowUpRight" | "check" | "x" | "play" | "download" | "upload"
  | "camera" | "image" | "orbit" | "dollyR" | "dollyL" | "pan" | "pushIn"
  | "parallax" | "settings" | "menu" | "bell" | "search" | "film" | "sun"
  | "moon" | "sparkle" | "zap" | "clock" | "dollar" | "trash" | "more"
  | "bed" | "bath" | "ruler";
...
export function LEIcon({
  ...
  switch (name) {
    ...
    case "parallax":
      return <svg {...common}><path d="M3 7h8M3 12h14M3 17h10" /></svg>;
    case "settings":
      return (
        <svg {...common}>
          <circle cx="12" cy="12" r="3" />
    ...
    case "moon":
      return <svg {...common}><path d="M21 13A9 9 0 0111 3a7 7 0 1010 10z" /></svg>;
    case "sparkle":
      return (
        <svg {...common}>
    ...
    case "ruler":
      return <svg {...common}><path d="M2 12l10-10 10 10-10 10zM6 12l1 1M10 8l1 1M14 12l1 1M10 16l1 1" /></svg>;
    default:
      return <svg {...common}><path d="M5 12h14M13 6l6 6-6 6" /></svg>;
  }
}
